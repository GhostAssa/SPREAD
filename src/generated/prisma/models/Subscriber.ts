...
export type SubscriberWhereInput = {
  ...
  subscribedAt?: Prisma.StringFilter<"Subscriber"> | string
}
...
export type SubscriberScalarWhereWithAggregatesInput = {
  ...
  subscribedAt?: Prisma.StringWithAggregatesFilter<"Subscriber"> | string
}
...
export type SubscriberUpdateInput = {
  ...
  subscribedAt?: Prisma.StringFieldUpdateOperationsInput | string
}
...
export type SubscriberOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"email" | "subscribedAt", ExtArgs["result"]["subscriber"]>
...
export interface SubscriberDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const subscriberWithEmailOnly = await prisma.subscriber.findMany({ select: { email: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Subscribers and only return the `email`
   * const subscriberWithEmailOnly = await prisma.subscriber.createManyAndReturn({
   *   select: { email: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Subscribers and only return the `email`
   * const subscriberWithEmailOnly = await prisma.subscriber.updateManyAndReturn({
   *   select: { email: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface SubscriberFieldRefs {
  ...
  readonly subscribedAt: Prisma.FieldRef<"Subscriber", 'String'>
}
