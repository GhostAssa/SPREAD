...
export type FactWhereInput = {
  ...
  chipColor?: Prisma.StringFilter<"Fact"> | string
  title?: Prisma.StringFilter<"Fact"> | string
  body?: Prisma.StringFilter<"Fact"> | string
  sources?: Prisma.StringNullableListFilter<"Fact">
  sortOrder?: Prisma.IntFilter<"Fact"> | number
}
...
export type FactScalarWhereWithAggregatesInput = {
  ...
  chipColor?: Prisma.StringWithAggregatesFilter<"Fact"> | string
  title?: Prisma.StringWithAggregatesFilter<"Fact"> | string
  body?: Prisma.StringWithAggregatesFilter<"Fact"> | string
  sources?: Prisma.StringNullableListFilter<"Fact">
  sortOrder?: Prisma.IntWithAggregatesFilter<"Fact"> | number
}
...
export type FactCreateInput = {
  ...
  title: string
  body: string
  sources?: Prisma.FactCreatesourcesInput | string[]
  sortOrder?: number
}
...
export type FactUpdateInput = {
  ...
  sources?: Prisma.FactUpdatesourcesInput | string[]
...
export type FactCreatesourcesInput = {
  set: string[]
}

export type FactUpdatesourcesInput = {
  set?: string[]
  push?: string | string[]
}
...
export type FactOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "status" | "category" | "chipColor" | "title" | "body" | "sources" | "sortOrder", ExtArgs["result"]["fact"]>
...
export interface FactFieldRefs {
  ...
  readonly chipColor: Prisma.FieldRef<"Fact", 'String'>
  readonly title: Prisma.FieldRef<"Fact", 'String'>
  readonly body: Prisma.FieldRef<"Fact", 'String'>
  readonly sources: Prisma.FieldRef<"Fact", 'String[]'>
  readonly sortOrder: Prisma.FieldRef<"Fact", 'Int'>
}
